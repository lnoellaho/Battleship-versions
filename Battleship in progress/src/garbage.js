...
checkSpaceForBuffer(board, row, col, size, orientation){
    for(let i = 0; i < size; i++) {
        ...
        if (orientation === HORIZONTAL) {
            ...
            } else if (board[row][col + i] === SHIP || board[row][col + i] === BUFFER) {
                return false
            }
            ...
            } else if(board[row + i][col] === SHIP || board[row + i][col] === BUFFER) {
                return false
            }
